...
Gera posts sobre seus projetos usando Groq (grátis) e publica no LinkedIn.
...
LINKEDIN_URN   = os.environ["LINKEDIN_URN"]
...
def generate_post_with_groq(commit_msg: str, repo: str, files: str) -> str:
    """Chama a API do Groq para gerar o texto do post."""

    prompt = f"""Você é um desenvolvedor de software brasileiro que compartilha atualizações 
...
Retorne APENAS o texto do post, sem aspas nem explicações."""
    ...
    print("   Chamando Groq (llama-3.3-70b)...")
...
def main():
    ...
    print("\n🤖 Gerando post com Groq...")
    changed_files = get_changed_files()
    post_text = generate_post_with_groq(COMMIT_MSG, REPO_NAME, changed_files)
